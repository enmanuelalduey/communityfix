...
<title>CommunityFix - Iniciar Sesión</title>
...
<div class="flex justify-between items-center px-6 py-4 max-w-6xl mx-auto">
    ...
    <a href="/communityfix/?action=registro" class="bg-blue-700 text-white px-6 py-2 rounded-lg text-sm font-medium hover:bg-blue-800 transition-all">
        Registrarse
    </a>
</div>
</header>
...
<main class="flex-grow flex items-center justify-center py-12 px-4 relative overflow-hidden">
    ...
    <div class="w-full max-w-[480px] bg-white rounded-xl shadow-lg relative z-10 p-8 border border-gray-100">
        <div class="text-center mb-8">
            ...
            <h1 class="text-3xl font-bold text-gray-900 mb-1">Bienvenido</h1>
            <p class="text-gray-500">Accede para reportar y dar seguimiento a los problemas de tu comunidad.</p>
        </div>
        ...
        <form method="POST" action="/communityfix/?action=login" class="space-y-5">
            <div>
            ...
            <div>
                ...
                <a href="#" class="text-xs text-blue-600 hover:underline mt-1 block text-right">¿Olvidaste tu contraseña?</a>
            </div>
        ...
        <div class="mt-6 pt-6 border-t border-gray-100 text-center">
            <p class="text-sm text-gray-500">
                ¿No tienes cuenta?
                <a href="/communityfix/?action=registro" class="text-blue-700 font-medium hover:underline">Regístrate aquí</a>
            </p>
        </div>
    </div>
    ...
    <div class="hidden lg:flex flex-col ml-12 max-w-[380px]">
        <div class="bg-white/60 backdrop-blur-sm p-8 rounded-xl border border-gray-100 shadow-sm">
            <div class="mb-6">
                <span class="material-symbols-outlined text-blue-600" style="font-size:48px; font-variation-settings:'FILL' 1;">shield</span>
            </div>
            <h2 class="text-2xl font-bold text-gray-900 mb-3">Tu comunidad te necesita</h2>
            <p class="text-gray-500 mb-6 text-base leading-relaxed">Cada reporte que haces marca la diferencia. Únete a cientos de vecinos activos que están mejorando su entorno cada día.</p>
            <div class="space-y-3">
